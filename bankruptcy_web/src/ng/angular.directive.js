myApp.directive('myPagination',[function(){
    return {
        ...
        //     '</div>',
        templateUrl:'../ng/pagination.html',
        replace: true,
        scope: {
            conf: '='
        },
        link: function(scope, element, attrs){
            ...
            function getPagination(){
                ...
                scope.conf.numberOfPages =numberOfPages;
            ...
            //
            //     // return newValue;
            //     return scope.conf.currentPage+' '+scope.conf.guide + scope.conf.totalItems;
            //     // return scope.conf.ramdom;
            // }, getPagination);
